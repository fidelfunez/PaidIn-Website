...
export default function Navigation() {
  ...
  const navClassName = `fixed top-0 w-full z-50 ${
  ...
  // Safari: Use regular nav element, no animations
  if (isSafari) {
    return (
      <nav 
              ...
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Active indicator */}
                    {active && (
                      <div className="absolute -bottom-1 left-0 right-0 h-0.5 bg-gradient-to-r from-bitcoin to-orange-500 rounded-full" />
                    )}
                  </Link>
                );
              })}
              ...
              <div className="flex flex-col space-y-4 sm:space-y-6 mt-6">
                ...
                <div className="flex flex-col space-y-3 pt-6 border-t border-gray-200/50">
                  ...
                  <Button 
                    ...
                    onClick={() => {
                      window.location.href = 'https://app.paidin.io/signup';
                      setIsOpen(false);
                    }}
                  >
                    Get Started
  ...
  // Other browsers: Use Framer Motion animations
  return (
    <motion.nav 
      className={navClassName}
      initial={{ y: -100 }}
